...
check('api-contract.js: all 10 HT.history.* entries registered (9 stable + 1 internal)',
  allEntriesFound);
check('api-contract.js: version bumped to 1.23.0 (Story 1.11 follow-up bumped 1.22.0 → 1.23.0 for the 11 utils.js helpers promoted to HT.*; Story 3.12 + 3.11 — HT.recent + HT.pins + HT.homeSidebar + HT.viewSource + HT.highlight + HT.zipStore added; Story 3.7 + 3.8 — HT.export + HT.import added; Story 3.6 — history panel shape migration + cap 50)',
...
// F.39 — api-contract.js version is 1.23.0 (Story 1.11 follow-up bumped 1.22.0 → 1.23.0 for the 11 utils.js helpers promoted to HT.*; Story 3.12 bumped 1.15.0 → 1.16.0 for HT.recent + HT.pins + HT.homeSidebar; Story 3.11 bumped 1.14.0 → 1.15.0 for HT.viewSource + HT.highlight + HT.zipStore; Story 3.7 bumped 1.12.0 → 1.14.0 for HT.export)
check('F.39 api-contract.js: version bumped to 1.23.0',
  /version:\s*['"]1\.23\.0['"]/.test(CONTRACT_SRC));
